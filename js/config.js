...
window.getApiUrl = function() {
  ...
  // Si estamos en tu dominio personalizado
  if (
    hostname === 'www.daytonacleanservice.com' ||
    hostname === 'daytonacleanservice.com'
  ) {
  ...
  // Si estamos en GitHub Pages (por si accedes directo)
